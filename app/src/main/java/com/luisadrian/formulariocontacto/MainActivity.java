package com.luisadrian.formulariocontacto;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extras!=null){
            ...
            botonFecha.setText(getResources().getString(R.string.fecha)+": "+extras.getInt(getResources().getString(R.string.dia_nacimiento))+"/"+extras.getInt(getResources().getString(R.string.mes_nacimiento))+"/"+extras.getInt(getResources().getString(R.string.año_nacimiento)));
        }
    ...
    public void presionarBotonSiguiente(View v){
        ...
        if(editText1.getText().toString().length()<1 || editText2.getText().toString().length()<1 || editText3.getText().toString().length()<1 || editText4.getText().toString().length()<1 || botonFecha.getText().toString().length()==19){
