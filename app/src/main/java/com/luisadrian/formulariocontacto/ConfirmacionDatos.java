...
public class ConfirmacionDatos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nombreConfirmacion.setText("Nombre: "+nombreContacto);
        telefonoConfirmacion.setText("Tel: "+numeroContacto);
        correoConfirmacion.setText("Email: "+correoContacto);
        acercaConfirmacion.setText("Descripción: "+descripcionContacto);
        nacimientoConfirmacion.setText("Fecha de nacimiento: "+diaNacimientoContacto+"/"+mesNacimientoContacto+"/"+añoNacimientoContacto);
